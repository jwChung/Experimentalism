namespace Jwc.Experiment.Xunit
{
    ...
    public class TestCasesTest
    {
        ...
        [Fact]
        public void CreateWithExplicit3AndAuto2ReturnsCorrectTestCases()
        {
            var args1 = new[] { "a", "b", "c" };
            var args2 = new[] { 1, 2 };
            var args3 = new[] { new object(), new object(), new object() };

            var delegator = new Action<string, int, object, string, int>((a, b, c, d, e) => { });

            var actual = TestCases.WithArgs(args1, args2, args3).WithAuto<string, int>().Create(delegator).ToArray();
