...
Experiment.AutoFixture은 dll과 소스코드 파일을 함께 배포하여, 사용자로 하여금 특정 목적에 맞게 소스코드를 수정할 수 있게 해주는 이점을 제공하고 있습니다(customization). _Source code transformations_에 대한 자세한 사항은 NuGet의 [도움말](http://docs.nuget.org/docs/creating-packages/configuration-file-and-source-code-transformations#Source_Code_Transformations)을 참고하세요.
