...
{
    /// <summary>
    ///     Represents a verification error when testing whether all references of a certain
    ///     assembly are specified.
    /// </summary>
    [Serializable]
    public class RestrictiveReferenceException : Exception
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="RestrictiveReferenceException" />
        ///     class.
        /// </summary>
