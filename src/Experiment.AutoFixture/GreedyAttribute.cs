...
{
    /// <summary>
    ///     An attribute that can be applied to parameters indicate that the parameter value
    ///     should be created using the most greedy constructor that can be satisfied by an
    ///     <see cref="IFixture" />.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Gets a customization that associates a <see cref="GreedyConstructorQuery" /> with
