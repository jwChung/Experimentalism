...
namespace Jwc.Experiment.AutoFixture
{
    ...
    ///     should not have properties auto populated when the
    ///     <see cref="IFixture" /> creates an instance of that type.
    /// </summary>
    [AttributeUsage(AttributeTargets.Parameter, AllowMultiple = false)]
    public sealed class NoAutoPropertiesAttribute : CustomizeAttribute
    {
        /// <summary>
        ///     Gets a customization that stops auto population of properties for the type of the
        ///     parameter.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        ///     A customization that stops auto population of the <see cref="Type" /> of the
        ///     parameter.
        /// </returns>
