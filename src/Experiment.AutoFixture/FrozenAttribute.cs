...
namespace Jwc.Experiment.AutoFixture
{
    ...
    ///     should be frozen so that the same instance is returned every time the
    ...
    {
        /// <summary>
        ///     Gets or sets the <see cref="Type" /> that the frozen parameter value should be
        ///     mapped to in the <see cref="IFixture" />.
        /// </summary>
